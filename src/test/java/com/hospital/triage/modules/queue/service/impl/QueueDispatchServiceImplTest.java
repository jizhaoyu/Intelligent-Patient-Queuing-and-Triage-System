...
class QueueDispatchServiceImplTest {
    ...
    void setUp() {
        ...
        properties.setCallNextRetryTimes(1);
        properties.setAllowDeptFallback(true);
        properties.setSeverePriorityRoomByDept(Map.of(1L, 1L));
    ...
    void shouldCalculateEstimatedRankFromWaitingList() throws Exception {
        ...
        double score = (double) method.invoke(service, ticket("T1", QueueStatusEnum.WAITING.name(), 500, 10), LocalDateTime.now());
    ...
    void shouldClearStaleCallingTicketWhenDbStatusIsNotCalling() throws Exception {
        ...
        when(queueTicketMapper.selectOne(any())).thenReturn(waitingTicket);
